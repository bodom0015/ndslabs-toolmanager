 ...
 */
.controller('ToolCtrl', [ '$log', '$scope', '$window', '$routeParams', '$http', 'MOCK', 'Tools', 'Instances', 'ToolInstance', 'Tool',
      function($log, $scope, $window, $routeParams, $http, MOCK, Tools, Instances, ToolInstance, Tool) {
    $scope.instances = {};
